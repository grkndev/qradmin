...
export default function CategoriesList() {
  ...
  const [newCategoryImage, setNewCategoryImage] = useState<any>();
  const [editCategory, setEditCategory] = useState<Partial<Category>>();
  const [editCategoryImage, setEditCategoryImage] = useState<any>();
  ...
  async function handleEdit() {
    ...
    formData.append("categoryId", editCategory?.categoryId || "");
  ...
  const handleSubmit = async (e: any) => {
    ...
    const fileSize = (newCategoryImage as File)?.size;
                    ...
                    <div className="grid grid-cols-4 items-center gap-4 ">
                      ...
                      {editCategoryImage && (
                        <Image
                          className=""
                          src={
                            editCategoryImage instanceof File
